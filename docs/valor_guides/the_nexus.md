...
The Aspect Hall holds all of a players [Aspects](https://wiki.valorserver.com/docs/items/misc/aspects). You can only use one aspect at a time so make your choice wisely. Not all aspects are items that drop from bosses, so a full list of all aspects can be found **[Here](https://wiki.valorserver.com/docs/items/misc/aspects)**.
